...
# Put a `pi-science` command on PATH. The shim only forwards to this checkout,
# so the launcher keeps working after a git pull without reinstalling.
