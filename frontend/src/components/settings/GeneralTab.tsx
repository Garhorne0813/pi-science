  ...
  return (
    <section className="divide-y divide-faint border-b border-faint">
      <label className="flex min-h-14 items-center justify-between gap-3 py-2">
        <span className="text-[13px] font-medium text-text">{t("settings.appearance.label")}</span>
      ...
      <label className="flex min-h-14 items-center justify-between gap-3 py-2">
        <span className="text-[13px] font-medium text-text">{t("settings.language.label")}</span>
