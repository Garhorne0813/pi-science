 ...
 *  Three fixes for model output, applied only outside code:
 ...
 *  2. convert standalone model-style `\\[...\\]` display delimiters and
 *     inline `\\(...\\)` delimiters to the dollar delimiters supported by
 *     remark-math. Bracket delimiters embedded in prose, blockquotes or list
 *     items are left untouched because inserting newlines would corrupt their
 *     Markdown container;
