...
export function createServerModules(config?: ServerConfig, options: ServerModuleOptions = {}): ServerModules {
  ...
  return { sessions, events, sessionRepository, piManager, settings, jobs, research, projectReview, literature, scientificRuntime, environments, stateStore, workspaces, environmentRepository, jobRepository, sqliteEnabled, scheduled };
}
