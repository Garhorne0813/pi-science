...
export const routeBoundaries: readonly RouteBoundary[] = [
  ...
  { prefix: "/api/research", owner: "node-control-plane", availability: "native" },
  { prefix: "/api/research-events", owner: "node-control-plane", availability: "native" },
  ...
  { prefix: "/api/provider-endpoint-bindings", owner: "node-control-plane", availability: "native" },
  { prefix: "/api/custom-providers", owner: "node-control-plane", availability: "native" },
